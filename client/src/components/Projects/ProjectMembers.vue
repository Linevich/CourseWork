            ...
            <b-col cols="12" md="6">
                ...
                <b-list-group v-for="(value, index) in members">
                    <b-list-group-item>
                        ...
                        <b-form-checkbox size="sm" v-model="members[index].changeProject"  :disabled="!changeUser(index)">Can change project</b-form-checkbox>
                        <b-form-checkbox size="sm" v-model="members[index].deleteProject" :disabled="!changeUser(index)">Can delete project</b-form-checkbox>
                        <b-form-checkbox size="sm" v-model="members[index].addTasks" :disabled="!changeUser(index)">Can add tasks</b-form-checkbox>
                        <b-form-checkbox size="sm" v-model="members[index].changeTasks" :disabled="!changeUser(index)">Can change tasks</b-form-checkbox>
                        <b-form-checkbox size="sm" v-model="members[index].deleteTasks" :disabled="!changeUser(index)">Can delete tasks</b-form-checkbox>
                    </b-list-group-item>
                ...
                <div class="m-3">
                    ...
                    <b-button :to="`/project/${id}`">Cancel</b-button>
                </div>
            </b-col>
        </b-row>
    </b-container>
        ...
        async changeMembers(){
            try{
                ...
                if (value && this.user.addMembers) {
                    await ProjectServices.projectAddMembers(this.id, this.members)
                }
                if (value && this.user.changeMembers) {
                    await ProjectServices.projectChangeMembers(this.id, this.members)
                }
        ...
        async  deleteMember(user) {
            try{
                ...
                if (value && this.user.deleteMembers) {
                    await ProjectServices.projectDeleteMembers(this.id, [user])
