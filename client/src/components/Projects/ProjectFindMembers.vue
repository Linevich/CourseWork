                ...
                <b-list-group-item>
                    ...
                    <b-dropdown variant="outline-primary" dropright>
                        <b-dropdown-form >
                            ...
                            <b-form-checkbox size="sm" v-model="members[index].changeProject"  switch>Can change project</b-form-checkbox>
                            <b-form-checkbox size="sm" v-model="members[index].deleteProject" switch>Can delete project</b-form-checkbox>
                            <b-form-checkbox size="sm" v-model="members[index].addTasks" switch>Can add tasks</b-form-checkbox>
                            <b-form-checkbox size="sm" v-model="members[index].changeTasks" switch>Can change tasks</b-form-checkbox>
                            <b-form-checkbox size="sm" v-model="members[index].deleteTasks" switch>Can delete tasks</b-form-checkbox>
                        </b-dropdown-form>
                    </b-dropdown>
                </b-list-group-item>
            </b-list-group>
